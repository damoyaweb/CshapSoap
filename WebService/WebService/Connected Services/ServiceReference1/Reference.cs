...
namespace ServiceReference1
{
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3-preview3.21351.2")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://learnwebservices.com/services/hello", ConfigurationName="ServiceReference1.HelloEndpoint")]
    public interface HelloEndpoint
    {
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        ServiceReference1.SayHelloResponse SayHello(ServiceReference1.SayHello request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<ServiceReference1.SayHelloResponse> SayHelloAsync(ServiceReference1.SayHello request);
    }
    ...
    public partial class SayHello
    {
        ...
        public ServiceReference1.SayHelloBody Body;
        
        public SayHello()
        {
        }
        
        public SayHello(ServiceReference1.SayHelloBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class SayHelloBody
    {
        ...
        public ServiceReference1.helloRequest HelloRequest;
        
        public SayHelloBody()
        {
        }
        
        public SayHelloBody(ServiceReference1.helloRequest HelloRequest)
        {
    ...
    public partial class SayHelloResponseBody
    {
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false, Order=0)]
        public ServiceReference1.helloResponse HelloResponse;
        
        public SayHelloResponseBody()
        {
        }
        
        public SayHelloResponseBody(ServiceReference1.helloResponse HelloResponse)
        {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3-preview3.21351.2")]
    public interface HelloEndpointChannel : ServiceReference1.HelloEndpoint, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3-preview3.21351.2")]
    public partial class HelloEndpointClient : System.ServiceModel.ClientBase<ServiceReference1.HelloEndpoint>, ServiceReference1.HelloEndpoint
    {
        ...
        public ServiceReference1.SayHelloResponse SayHello(ServiceReference1.SayHello request)
        {
            return base.Channel.SayHello(request);
        }
        
        public System.Threading.Tasks.Task<ServiceReference1.SayHelloResponse> SayHelloAsync(ServiceReference1.SayHello request)
        {
